...
export function executeBuy(state, account, input, quote, model, orderId, now) {
  ...
  const provenance={candidateSource:input.candidateSource,candidateId:input.candidateId,moverId:input.moverId||null,sourceObservedAt:input.sourceObservedAt,opportunityId:input.opportunityId,scanCycleId:input.scanCycleId,boardHash:input.boardHash,decisionId:input.decisionId,strategyVersion:input.strategyVersion,executionModelVersion:model.version};
...
export function executeSell(state, account, input, quote, model, orderId, now) {
  ...
  const provenance={candidateSource:position.candidateSource,candidateId:position.candidateId,moverId:position.moverId||null,sourceObservedAt:position.sourceObservedAt,opportunityId:position.opportunityId,scanCycleId:position.scanCycleId,boardHash:position.boardHash,decisionId:position.decisionId,closeDecisionId:input.decisionId||null,strategyVersion:position.strategyVersion,executionModelVersion:model.version};
